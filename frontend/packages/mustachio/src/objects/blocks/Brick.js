...
import { BLOCK_SIZE, BRICK_SCORE, BRICK_DEBRIS_SPEEDS_X, BRICK_DEBRIS_SPEEDS_Y, } from '../../constants';
...
export class Brick extends Phaser.Physics.Arcade.Sprite {
    ...
    punch() {
        ...
        for (let i = 0; i < 4; i++) {
            new BrickDebris(this.scene, this.x + this.displayWidth / 2, this.y + this.displayHeight / 2, BRICK_DEBRIS_SPEEDS_X[i], BRICK_DEBRIS_SPEEDS_Y[i]);
        }
        this.destroy();
    }
}
