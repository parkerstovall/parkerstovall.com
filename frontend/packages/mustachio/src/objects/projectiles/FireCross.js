...
import { BLOCK_SIZE, FIRE_COLOR, FIRE_CROSS_GROW_SPEED, FIRE_CROSS_MAX_LENGTH, FIRE_CROSS_MIN_LENGTH, FIRE_CROSS_THICKNESS, } from '../../constants';
const Dir = {
    UP: 1,
    DOWN: 2,
    LEFT: 3,
...
export class FireCross extends Phaser.GameObjects.Rectangle {
    dir;
    maxLength = FIRE_CROSS_MAX_LENGTH;
    minLength = FIRE_CROSS_MIN_LENGTH;
    growSpeed = FIRE_CROSS_GROW_SPEED;
    anchorX;
    anchorY;
    currentLength = FIRE_CROSS_MIN_LENGTH;
    growing = true;
    constructor(scene, parentX, parentY, dir) {
