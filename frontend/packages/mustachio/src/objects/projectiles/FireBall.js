...
import { FIREBALL_SPEED, FIREBALL_TRACKING_SPEED, GAME_WIDTH, GAME_HEIGHT, PROJECTILE_SIZE, PROJECTILE_CULL_MARGIN, FIREBALL_SPAWN_Y_OFFSET, FIREBALL_TRACKING_CHANCE, FIREBALL_LIFETIME, } from '../../constants';
export class FireBall extends Phaser.Physics.Arcade.Sprite {
    tracking;
    constructor(scene, parent) {
        super(scene, parent.x + parent.displayWidth / 2, parent.y + parent.displayHeight + FIREBALL_SPAWN_Y_OFFSET, 'stache-ball');
